...
void VADC_Pst_S_user_init(test_function& func)
{
	VADC_Pst_S_params *ours;
    ours = (VADC_Pst_S_params *)func.params;
...
// Datalog gFuncNum variable //
	if(gDisplay_FuncNum)
		PiDatalog(func, A_Func_Num_VADC_Post, gFuncNum, 27, POWER_UNIT);
	...
	// Test Names //
	float VADC_Post_S      =0;
	float VADC_Delta_S     =0;
	float VADC_Test1_S     =0; 
	float VADC_Test2_S     =0;
	float VADC_Post_TT    = 0;
