//==============================================================================
// VR_D_Ext_01_S.cpp (User function)
// 
...
void VR_D_Ext_01_S_user_init(test_function& func)
{
	VR_D_Ext_01_S_params *ours;
    ours = (VR_D_Ext_01_S_params *)func.params;
...
// Datalog gFuncNum variable //
	if(gDisplay_FuncNum)
		PiDatalog(func, A_Func_Num_VR_DE_01_S, gFuncNum, 27, POWER_UNIT);
...
VR_Detect_A_Search(B1_FastUpdate, B2_MaxSate, A_Skipping, A1_MinState, A2_FastUpdate, A3_Target_VR, VStart, Vstop, VstepSize);
	...
	g_B2_MaxSate    = B2_MaxSate;
	g_B1_FastUpdate = B1_FastUpdate;
	g_A3_Target_VR  = A3_Target_VR;
	g_A2_FastUpdate = A2_FastUpdate;
	g_A1_MinState   = A1_MinState;
	g_A_Skipping    = A_Skipping;
...
////////////	////////}
	...
	PiDatalog(func, A_VR_DE01_Opt,		  g_Trim_TvrOption_B16_17_S_Trimops,      26, POWER_UNIT);
	PiDatalog(func, A_AVR_DE01_Tap1,		  VFB_Meas[4],               26, POWER_UNIT);
	PiDatalog(func, A_AVR_DE01_Tap2,		  VFB_Meas[1],               26, POWER_UNIT);
	PiDatalog(func, A_AVR_DE01_Tap3,		  VFB_Meas[2],               26, POWER_UNIT);
	PiDatalog(func, A_AVR_DE01_Tap4,		  VFB_Meas[3],               26, POWER_UNIT);

	PiDatalog(func, A_VFB_ExHBP_44_01,		  VFB,               26, POWER_UNIT);
	...
	PiDatalog(func, A_A0_ExHBP_44_01, A_Skipping,				 26, POWER_UNIT);
	PiDatalog(func, A_A1_ExHBP_44_01, A1_MinState,				 26, POWER_UNIT);
	PiDatalog(func, A_A2_ExHBP_44_01, A2_FastUpdate,			 26, POWER_UNIT);
	PiDatalog(func, A_A3_ExHBP_44_01, A3_Target_VR,				 26, POWER_UNIT);


	PiDatalog(func, A_B1_ExHBP_44_01,	  B1_FastUpdate,		 26, POWER_UNIT);
	PiDatalog(func, A_B2_ExHBP_44_01,	  B2_MaxSate,			 26, POWER_UNIT);

	PiDatalog(func, A_BSk_ExHBP_44_01,  B_Skip_5K,				 26, POWER_UNIT);
	PiDatalog(func, A_BD_ExHBP_44_01,	  B_5K,				     26, POWER_UNIT);
	PiDatalog(func, A_BLOSkExHBP44_01,BLO_Skip_5K,				 26, POWER_UNIT);

	PiDatalog(func, A_BLO_ExHBP44_01,	  BLO_5K,				     26, POWER_UNIT);
	PiDatalog(func, A_B3_ExHBP_44_01,	  B3_UVLO_5K,				 26, POWER_UNIT);
