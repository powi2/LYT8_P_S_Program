...
void VR_Detect_S_user_init(test_function& func)
{
	VR_Detect_S_params *ours;
    ours = (VR_Detect_S_params *)func.params;
...
// Datalog gFuncNum variable //
	if(gDisplay_FuncNum)
		PiDatalog(func, A_Func_Num_VR_Detect_S, gFuncNum, 27, POWER_UNIT);
...
VR_Detect_A_Search(B1_FastUpdate, B2_MaxSate, A_Skipping, A1_MinState, A2_FastUpdate, A3_Target_VR, VStart, Vstop, VstepSize);
	...
	PiDatalog(func, A_AVR_Tap4,		  VFB_Meas[3],               26, POWER_UNIT);

	PiDatalog(func, A_VFB_InHBP_44_00,		  VFB,               26, POWER_UNIT);
	...
	PiDatalog(func, A_A0_InHBP_44_00, A_Skipping,				 26, POWER_UNIT);
	PiDatalog(func, A_A1_InHBP_44_00, A1_MinState,				 26, POWER_UNIT);
	PiDatalog(func, A_A2_InHBP_44_00, A2_FastUpdate,			 26, POWER_UNIT);
	PiDatalog(func, A_A3_InHBP_44_00, A3_Target_VR,				 26, POWER_UNIT);


	PiDatalog(func, A_B1_InHBP_44_00,	  B1_FastUpdate,		 26, POWER_UNIT);
	PiDatalog(func, A_B2_InHBP_44_00,	  B2_MaxSate,			 26, POWER_UNIT);

	PiDatalog(func, A_BSk_InHBP_44_00,  B_Skip_5K,				 26, POWER_UNIT);
	PiDatalog(func, A_BD_InHBP_44_00,	  B_5K,				     26, POWER_UNIT);
	PiDatalog(func, A_BLOSkInHBP44_00,BLO_Skip_5K,				 26, POWER_UNIT);

	PiDatalog(func, A_BLO_InHBP44_00,	  BLO_5K,				     26, POWER_UNIT);
	PiDatalog(func, A_B3_InHBP_44_00,	  B3_UVLO_5K,				 26, POWER_UNIT);
