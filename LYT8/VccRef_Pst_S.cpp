//==============================================================================
// VccRef_Pst_S.cpp (User function)
// 
...
void VccRef_Pst_S_user_init(test_function& func)
{
	VccRef_Pst_S_params *ours;
    ours = (VccRef_Pst_S_params *)func.params;
...
// Datalog gFuncNum variable //
	if(gDisplay_FuncNum)
		PiDatalog(func, A_Func_Num_VccRef_Pst, gFuncNum, 27, POWER_UNIT);
	...
	float VccRef_Delta_S   = 0;
	float VccRef_Test_S    = 0;
	float VccRef_Pst_TT    = 0;
